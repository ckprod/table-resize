    ...
    (function () {
		...
		ResizeHandler.prototype._mousePrepareDrag = function (event) {
            ...
            var cell = this.hr.cells[initialColumn],
				...
				width = width === false?(cell.clientWidth-numericProperty(elementStyleProperty(cell, 'paddingLeft'))-numericProperty(elementStyleProperty(cell, 'paddingRight')))+'px':width; // ie8 support
		...
		ResizeHandler.prototype._mouseStopDrag = function () {
            ...
            var initialColumn = this.ic,
                cell = this.hr.cells[initialColumn],
				width = elementStyleProperty(cell, 'width'),
				width = cell.clientWidth-numericProperty(elementStyleProperty(cell, 'paddingLeft'))-numericProperty(elementStyleProperty(cell, 'paddingRight'));
